#!/bin/bash
#SBATCH -J map_reads_fresh_water_metagenomes # Job name
#SBATCH -o map_reads_fresh_water_metagenomes.o%j # Name of Output File
#SBATCH -e map_reads_fresh_water_metagenomes.e%j # Name of Error File
...
data_dir=/fs/cbcb-lab/mpop/hotspring_metagenome/Synechococcus_paper_analysis/Data/Freshwater_Metagenomes/
out_dir=/fs/cbcb-lab/mpop/hotspring_metagenome/Synechococcus_paper_analysis/Freshwater_Metagenomes/
align_dir=/fs/cbcb-lab/mpop/hotspring_metagenome/Synechococcus_paper_analysis/Freshwater_Metagenomes/alignments/
reads_dir=/fs/cbcb-lab/mpop/hotspring_metagenome/Synechococcus_paper_analysis/Freshwater_Metagenomes/reads/
